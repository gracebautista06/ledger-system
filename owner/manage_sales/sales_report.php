                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="font-family:monospace; font-size:0.75rem; color:var(--text-muted); white-space:nowrap; line-height:1.9;">
                            <?php
                            $bk = [];
                            $sm = ['PW'=>$row['qty_pw'],'S'=>$row['qty_s'],'M'=>$row['qty_m'],'L'=>$row['qty_l'],'XL'=>$row['qty_xl'],'J'=>$row['qty_j']];
                            foreach ($sm as $sz => $qt) { if ($qt > 0) $bk[] = "<span style='color:var(--text-primary);font-weight:700;'>$sz</span>&times;$qt"; }
